#########################################################################################################################################################################################
#                                                                                                                                                                                       #
# This script extends the original script developed by Microsoft found at: https://github.com/Azure/azure-devtestlab/blob/master/Artifacts/windows-chocolatey/install-choco-package.ps1 #
# Instead of installing the latest version of a package, this script allows you to specify a specific version of a package to install.                                                  #
#                                                                                                                                                                                       #
#########################################################################################################################################################################################
...
function Install-Package
{
    ...
    $expression = "$ChocoExePath install -y -f --acceptlicense $checkSumFlags --no-progress --stoponfirstfailure --version $Version $Package"
